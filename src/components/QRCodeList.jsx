...
import { activeQRCodes, qrRequests } from '../utils/qrCodeData';
              ...
              >
                <div className="flex items-start space-x-3 md:space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-3">
                      <div className="bg-green-50 text-green-700 text-xs md:text-sm px-3 py-1.5 md:py-2 rounded-full flex items-center justify-between cursor-pointer hover:bg-green-100 transition-colors">
